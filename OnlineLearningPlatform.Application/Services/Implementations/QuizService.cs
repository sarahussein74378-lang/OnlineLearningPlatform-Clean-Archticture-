...
public class QuizService : IQuizService
{
    ...
    {
        var quiz = await _unitOfWork.Quizzes.GetQuizWithQuestionsAndAnswersAsync(id);
    ...
    public async Task<QuizResultDto> SubmitAsync(SubmitQuizDto dto, string studentUserId)
    {
        ...
        var quiz = await _unitOfWork.Quizzes.GetQuizWithQuestionsAndAnswersAsync(dto.QuizId);
