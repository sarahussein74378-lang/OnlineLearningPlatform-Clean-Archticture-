...
public class CertificateService : ICertificateService
{
    ...
    Task<CertificateDto?> ICertificateService.GetByEnrollmentAsync(int enrollmentId)
    {
        throw new NotImplementedException();
    }

    Task<IEnumerable<CertificateDto>> ICertificateService.GetStudentCertificatesAsync(string studentUserId)
    {
        throw new NotImplementedException();
    }

    Task<CertificateDto?> ICertificateService.IssueCertificateAsync(int enrollmentId)
    {
        throw new NotImplementedException();
    }
}
