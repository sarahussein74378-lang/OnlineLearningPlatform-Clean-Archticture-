...
public class EnrollmentService : IEnrollmentService
{
    ...
    Task<EnrollmentDto?> IEnrollmentService.EnrollAsync(int courseId, string studentUserId)
    {
        throw new NotImplementedException();
    }

    Task<IEnumerable<EnrollmentDto>> IEnrollmentService.GetStudentEnrollmentsAsync(string studentUserId)
    {
        throw new NotImplementedException();
    }
}
