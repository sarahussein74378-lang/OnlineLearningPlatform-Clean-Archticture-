    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EnrolledSince = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Certificates_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QuizSubmissions_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizSubmissionAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuizSubmissionAnswers_Answers_SelectedAnswerId",
                        column: x => x.SelectedAnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_QuizSubmissionAnswers_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_QuizSubmissionAnswers_QuizSubmissions_QuizSubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificates_StudentProfileId",
                table: "Certificates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizSubmissionAnswers_QuestionId",
                table: "QuizSubmissionAnswers",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizSubmissionAnswers_QuizSubmissionId",
                table: "QuizSubmissionAnswers",
                column: "QuizSubmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizSubmissionAnswers_SelectedAnswerId",
                table: "QuizSubmissionAnswers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizSubmissions_StudentProfileId",
                table: "QuizSubmissions",
                column: "StudentProfileId");
